...
import clima from './services/climaApi';
import prevision from './services/previsionAPI'
import { BsFillArrowRightCircleFill, BsFillHouseFill } from "react-icons/bs";
import './app.css';
